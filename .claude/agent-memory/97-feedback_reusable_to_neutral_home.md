...
**Codified:** the canonical rule is `docs/agent/platform-decisions.md#reusable-neutral-home` (the statute is source-of-truth; any `#NNN` above is provenance, not the reference).

...
**Codified:** the canonical rule is `docs/agent/platform-decisions.md#cross-origin-dev-server-hygiene` (the statute is source-of-truth; any `#NNN` above is provenance, not the reference).

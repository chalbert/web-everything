...
description: Every user brand/design judgment gets logged as a labeled example in WE #2207's Learning log — it's the training corpus for the design-AI reviewer
metadata:
  type: feedback
---

...
3. **Write the report** `reports/<YYYY-MM-DD>-backlog-split-analysis.md` — two tables: **could split**
   ...
   in the backlog as a Tier-B item (*Where an open question goes*).
4. **Stop and present.** Report the analysis. For each splittable candidate, show the proposed slices +

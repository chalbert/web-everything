...
**Date:** 2026-06-02
**Status (2026-06-03):** Partially graduated. The terminology table, "three faces of a trait", "from markup to traits" mapping, and "droplist substrate" definition now live on the [Droplist block](/blocks/droplist/); the Step 1 (single dropdown) markup is on the [Dropdown block](/blocks/dropdown/). The "Autocomplete in detail" section remains here as seed content for the [autocomplete block](/backlog/autocomplete-block/) backlog item; the open contracts in §"Open questions" are tracked in [droplist-composition-open-contracts](/backlog/droplist-composition-open-contracts/).

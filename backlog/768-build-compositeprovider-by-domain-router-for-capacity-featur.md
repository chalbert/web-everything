...
- **Module:** [capabilities/composite.ts](../capabilities/composite.ts), exported via `capabilities/index.ts`.
...
- **Tests:** [capabilities/__tests__/composite.test.ts](../capabilities/__tests__/composite.test.ts) — 7 cases (router dispatch + collapse, per-domain routing, unknown-degrade, readAll/adapters/isNative). Full capabilities suite 135/135.

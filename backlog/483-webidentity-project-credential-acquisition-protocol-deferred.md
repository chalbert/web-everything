...
graduatedTo: "project:webidentity"
tags: []
---
...
- `webidentity` project entry in [we:projects.json](../src/_data/projects.json) (+ `webidentity.svg` icon).
- `credential-management` protocol in [we:protocols.json](../src/_data/protocols.json) (`ownedByProject: webidentity`, `realizesIntent: web-identity`, `anchor: protocol-credential-management`).
- [we:project-webidentity.njk](../src/_includes/project-webidentity.njk) spec partial — mission · feature-surface table · `CustomCredentialProvider` interface · 3 members · 2-D family×member dispatch · trust boundary · composition · status.

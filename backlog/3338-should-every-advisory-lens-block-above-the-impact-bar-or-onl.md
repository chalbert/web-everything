...
> ## Do not rule this yet — `blockedBy` #3374 (added 2026-08-27)
>
...
>
> [`#3374`](/backlog/3374-calibrate-the-finding-consequence-scale-one-axis-or-two-asse/) prepares
...
> repeats a prop [`#3374`](/backlog/3374-calibrate-the-finding-consequence-scale-one-axis-or-two-asse/)
...
> #3374 is ruled, and take the anchor-agreement number as an input Done-when 3 did not previously have.

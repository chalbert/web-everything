...
- Unit tests `fui:dockTopology.test.ts` (hit-testing zones + edge fraction; split/merge mutation; prune+collapse; immutability; no-op cases). 29/29 dockable unit tests green.

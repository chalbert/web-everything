...
This AI-generated candidate from the [#142 pool](/backlog/142-ai-generated-dev-experience-feature-candidates/) earns a go/not-yet/no validation gate, not a merit fork. The idea: compare a page's **declared intents** — the density, motion, and a11y commitments the app states for itself — against what the page **actually does** at runtime, and flag the gap. It's WCAG-and-more checked against *your own declarations*: not just "does this meet a generic standard" but "does this match what *you said this page would be*." Generic a11y tools (axe, Lighthouse) check against a universal ruleset; none check against a page's self-declared intent, because in other stacks there is no declared intent to check against.

...
- **Tests** — `__tests__/RangeCoordination.test.ts` (5: locate+report, drag-start-pushes-end, drag-end-pulls-start, ordered-edit-untouched, range-change event) green; FUI `check:standards` green (16 traits).

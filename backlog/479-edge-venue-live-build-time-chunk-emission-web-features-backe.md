...
Sliced 2026-06-15 — see [reports/2026-06-15-backlog-split-analysis.md](../reports/2026-06-15-backlog-split-analysis.md).

## Children

- **#698 — web-features-backed `BaselineLookup`** (`story·2`, batchable now). Pure build, **not forked**:
  the doc at [`edge-io.ts:20`](../capabilities/edge-io.ts#L20) already names the impl and capability ids
  ...
  `BaselineLookup` ([`edge-io.ts:69`](../capabilities/edge-io.ts#L69)), unit-tested against the injection
  seam.
...
- **#699 — placement of the live edge serve runtime** (`type:decision`, **parked**). The live SERVE
  ...
  `Resolution`, not bytes — [`edge.ts:169`](../capabilities/edge.ts#L169)) is a live-serve product

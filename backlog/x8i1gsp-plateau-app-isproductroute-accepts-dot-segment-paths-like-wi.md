...
- **Related:** `x4ozdck`, the gate deep-link decision filed alongside this card. Under its default, the gate has its own local same-origin check and does not depend on this card. This card only fixes the SPA's own rule.

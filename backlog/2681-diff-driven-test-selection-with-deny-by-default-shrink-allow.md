...
4. **Keep the `push:[main]` full suite** as the post-land backstop, and record its false-green rate via #2680.
...
- Flag-gated; **not defaulted** until the measured false-green rate (#2680) is acceptable and a red-main
  recovery path exists. Re-justify the marginal win against **post-shard** (#2682) wall-clock before defaulting.

...
- **Axis 1 — public-tier delivery (the reshaping).** Does the "free public" tier get *built* (operate a
  ...
  ([087:33](backlog/087-module-service-distribution-caching.md)). **Skypack** is the cautionary tale: a
...
- **Cluster constraint.** Decide consistently with the open-core cluster — open=free, paid=value-add:
  **#089** product ideas, **#091** constellation layering (served product → plateau-app), **#097**
  emergent-MVP — and the standing **defer-live-serve** stance ([[project_monetization_strategy]]).
...
the constellation** ([[project_managed_offering_constellation_layering]] — #091's "no single home"
...
- **Components published to npm** → `@frontierui` (impl) ([[npm_scope_mirrors_layer]]) — the artifacts
...
- Parent: [087-module-service-distribution-caching.md](backlog/087-module-service-distribution-caching.md)
  — "Hosted-tier shape & pricing" decision ([:34](backlog/087-module-service-distribution-caching.md)),
  phasing ([:42](backlog/087-module-service-distribution-caching.md), phase d), "don't reinvent the
  wheel" note ([:33](backlog/087-module-service-distribution-caching.md)).
- Cluster: [#089](backlog/089-monetization-product-ideas.md) (product ideas),
  [#091](backlog/091-managed-offering-constellation-layering.md) (constellation layering),
  [#097](backlog/097-roadmap-to-mvp.md) (emergent MVP).

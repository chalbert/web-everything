...
parent: "4075"
status: open
blockedBy: ["xilx617", "x5h527v", "x2h9na8", "xknejbg", "xu38vlf", "x7w2lc1", "x7fupdt", "xzybygn"]
...
The work is split by FILE, not by gap type, so each slice has a disjoint code scope and slices can run in parallel: xilx617, x5h527v, x2h9na8, xknejbg, xu38vlf, x7w2lc1, x7fupdt, xzybygn. Each slice clears its own findings from the flow files. This card is now the closeout: once every slice has landed, confirm the check below and record the live proof.

...
# Conflict watch: unowned rebase attempts are capped and a withheld rearm is time-bounded (flow gaps, parked-pr-conflict-watch)

parked-pr-conflict-watch: count unowned mechanical-rebase attempts per head and stop at a cap; a rearm withheld on name-based liveness past a clock bound is re-armed or surfaced. Clears conflict unowned-mechanical-rebase-attempt and rearm-deferred (xb4yerj, xwo3j0l).
...
- conflict unowned-mechanical-rebase-attempt (uncapped-retry)
- conflict rearm-deferred (unbounded-wait)

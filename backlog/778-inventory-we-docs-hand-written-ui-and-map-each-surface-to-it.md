...
- Produced the audit report: [reports/2026-06-16-we-docs-ui-inventory-fui-map.md](../reports/2026-06-16-we-docs-ui-inventory-fui-map.md) (exposed via `relatedReport`).
- **10 chrome surfaces** (base.njk header/nav/footer/shell + reveal-nav.js) and **10 page-level surfaces** (catalog tiles, sortable tables, toolbar, badges, buttons, code frame, toggles, meters, project layout, fui-demo) enumerated, each mapped to a FUI block.

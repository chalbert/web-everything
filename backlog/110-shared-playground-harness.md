...
> **Resolved 2026-06-06.** The shared harness now exists as `demos/playground-harness.ts` plus
> `demos/playground.css`; the conformance playgrounds import it instead of copy-pasting the card / badge /

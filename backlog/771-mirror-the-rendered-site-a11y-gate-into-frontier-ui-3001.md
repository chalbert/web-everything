...
- **Allowlist:** `we:frontierui/tests/a11y/route-allowlist.ts` — FUI's own curated route set (`/`, `/blocks/`, `/adapters/`, `/demos/`, `/plugs/`, `/traits/`, `/about/`) + the WCAG 2.0/2.1 A+AA tag set.

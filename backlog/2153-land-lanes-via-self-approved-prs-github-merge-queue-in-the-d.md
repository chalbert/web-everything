...
- **Live-verified end-to-end:** this very item was **landed via `we:scripts/pr-land.mjs` itself** — a self-approved PR from its `lane/*` ref, required `test` check green, merged to `main` (dogfood, mirroring how #2165 landed via PR #4). See the landing PR on this commit.

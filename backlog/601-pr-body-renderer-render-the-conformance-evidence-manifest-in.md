...
- **`plateau:pr-body.test.ts`** — 9 tests: red→green headline, not-restored warning, gate table, subject/autonomy/footer, markdown escaping, determinism, and the forge hand-off (default + explicit title/base).

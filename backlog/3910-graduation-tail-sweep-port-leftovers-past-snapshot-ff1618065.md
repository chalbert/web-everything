...
parent: "3443"
status: open
blockedBy: ["3487", "3862", "3863", "3485", "3894", "3899", "3896", "3900", "3909", "3904", "3905", "x0n0eiz", "xvlu8t1"]
...
- 2026-09-25: graduation-import-check moved `we:AGENTS.md` to #xvlu8t1 — #xvlu8t1's `we:scripts/check-standards.mjs` needs it directly, and this card already (transitively) depends on #xvlu8t1, so a blockedBy edge the other way would cycle.
- 2026-09-25: graduation-import-check moved `we:scripts/__tests__/lane-verify.test.mjs` here from #x0n0eiz — it imports a module this card owns.
...
Added `x0n0eiz` and `xvlu8t1` to `blockedBy` — both are post-snapshot tail cards (parent #3443, `--queue=false`)
covering the `600acc14f..6a2c8c1ab` delta (13 commits) that landed while this epic's other slices were still
open: `x0n0eiz` (lane-pool/lane-lease/verify-lane/guard-bash/poc-land landing tooling) and `xvlu8t1`

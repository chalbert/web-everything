...
every test still runs, just split across runners — so unlike scope-driven selection (#xo1m764) it cannot produce a
...
- Measured wall-clock cut recorded against the #xfgacpz instrument, so #xo1m764's marginal delta can be judged

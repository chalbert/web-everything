...
> **Reframed under epic #2289 (2026-07-05).** This drain-side rebase-drop heal is **kept** as the backstop at the sole writer — see #2291. Prevention (drain-only #2290 + JIT numbering #2288) is now primary; this is the safety net that should never fire post-JIT.

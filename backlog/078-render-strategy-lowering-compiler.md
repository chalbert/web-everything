...
- **Done:**
  ...
  - Tests: `we:blocks/__tests__/unit/renderers/crossStrategy.test.ts` (17 tests) — per-rule lower/lift, structural round-trips, lossy pins. Full renderer suite **160/160 green**; `tsc --noEmit` clean on new files; `check:standards` 0 errors.

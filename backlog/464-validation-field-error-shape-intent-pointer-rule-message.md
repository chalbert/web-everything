...
New [validation-generation/fieldError.ts](../validation-generation/fieldError.ts) — the field-error shape, dependency-free TS model beside the #304 generation vocabulary, re-exported from the `webvalidation` plug ([index.ts](../plugs/webvalidation/index.ts)):

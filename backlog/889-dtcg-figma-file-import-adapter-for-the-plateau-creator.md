...
- **Tests** — `plateau:importAdapter.test.ts` (8: DTCG flatten, Figma map, detect, dispatch+errors) + 2 creator import tests (DTCG import appears as editable tokens + persists; unrecognized-format error surfaced). Full plateau suite green (232 tests).

...
parent: "181"
status: open
humanGate: { kind: review, what: "Pre-sale legal & business-protection review (entity, trademark registration, commercial license, EULA, E&O, DPA) — a professional/human action, not agent-doable; required before charging money. The free-deploy hygiene half was split to #xwi0ou0." }
...
> split out to [#xwi0ou0](/backlog/xwi0ou0-public-deploy-legal-hygiene-what-a-free-we-only-deploy-actua/),
...
- **Trademark registration** — file our own marks ("Web Everything" / "Plateau" /
  ...
  pre-branding knock-out — lives in #xwi0ou0.)
- **OSS + commercial license split** — the policy is its own decision in
  ...
  honestly. (A LICENSE merely *being present* is #xwi0ou0.)
- **ToS / EULA (product)** — required to sell a licensed tool. A merchant-of-record
  ...
  (The free-site privacy notice is #xwi0ou0.)
...
that a free public deploy needs is no longer trapped in here — it's #xwi0ou0.**

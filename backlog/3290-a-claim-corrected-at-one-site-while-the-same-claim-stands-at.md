...
That is exact-comparable and is filed separately as `3287`, "A PR body's frontmatter claims are never
...
falsified by the commit that wrote it; that is the third sibling in this family, filed as `3286`, "A
...
the cited item at the target `main`. That is the fourth sibling, filed as `3288`, "A card's prose claim
...
stopped resolving to the sentence. That is the fifth sibling, filed as `3289`, "A `file:line` citation

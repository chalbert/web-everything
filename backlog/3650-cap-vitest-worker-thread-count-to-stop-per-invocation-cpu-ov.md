...
**Resolved as a duplicate pair, not as done.** This item and its twin `we:backlog/3663-cap-vitest-worker-thread-count-to-stop-per-invocation-cpu-ov.md` share `bornAs: 3663` — the identical
...
_converting the twin back to its hash-keyed form (`3663`), letting JIT-numbering assign a real NNN only_

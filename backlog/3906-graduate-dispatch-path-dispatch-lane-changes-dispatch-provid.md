...
## Routing slice delivered (2026-09-26, #3906 routing worker)
...
supervision hold (enforcement stays OFF, #4180); `buildAgentArgv` writes the #3857 table's `--model` and the run

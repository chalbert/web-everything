...
**Graduated to** `blocks/renderers/module-service/servePathIR.ts` — catalogGated flag + generation/backends/{javascript,csharp}.ts formCatalog seam (default form + unknown-form 400); goldens regenerated.

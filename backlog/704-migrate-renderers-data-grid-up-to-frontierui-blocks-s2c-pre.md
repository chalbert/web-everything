...
- **2026-06-15 — migrated.** Byte-identical copies of `renderDataGrid.ts`, `editableGrid.ts`, and both
...
- **Gate:** FUI's stricter `tsc -p blocks/tsconfig.json --noEmit` is **clean** — no latent type issue, so

...
Note also that #2849's shape is contingent on the open statute-layering decision (`xzadt1m`): if build status moves
...
tracked as `xat9huz`; this item is the **guard** that stops the class recurring. Related: #2849, `xat9huz`,
`xzadt1m`, `xi4syme` (the cite-from-title class this is one surface of).

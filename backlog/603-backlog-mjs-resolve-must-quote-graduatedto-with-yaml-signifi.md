...
- **Resolved 2026-06-14.** Added `quoteScalar(value)` to `we:scripts/backlog/frontmatter.mjs` —
  ...
  **body**, not a frontmatter scalar. Covered by 6 new `we:frontmatter.test.mjs` cases (plain slug stays

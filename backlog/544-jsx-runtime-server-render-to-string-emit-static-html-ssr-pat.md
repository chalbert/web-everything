...
- **Test** — [fui:renderToString.test.ts](../../frontierui/packages/jsx-runtime/__tests__/renderToString.test.ts), 14 tests green; canonical-sync still green; `tsc` build clean; FUI `check:standards` 0/0.

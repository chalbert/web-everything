...
2. screenshot it;
3. the agent READS the screenshot (sighted) and runs the Card-1 comparator (#xt1ouq4) against the committed baseline;
...
blockedBy: the Card-1 comparator (#xt1ouq4) — this layer has nothing to call until the shared primitive exists.

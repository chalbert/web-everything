...
**The trigger, concretely:** re-open when **#3315** (the per-category effective-false-positive meter) can state an adjudicated precision figure for the reviewer. At that point the #2631 experiment is repeatable with the measurement it lacked. #3315 is itself blocked on the verdict ledger (#3007 / #3255).

...
**Decision (un-parked 2026-06-22 — parking is not a prioritisation escape):** Whether to build the SWC-native trait transform (Turbopack/rspack) + Babel pre-step now, or defer until a consumer needs that toolchain reach.

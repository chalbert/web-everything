...
**Superseded 2026-09-23 by [#conveyor-multi-repo-model](../docs/agent/platform-decisions.md#conveyor-multi-repo-model) (`3965` Fork 1):** the fix path no longer refuses a repo for being "not WE"; it refuses only when the repo's profile lacks the fix capability. Do not ratify this fork's "accept the refusal" default.

...
- Added the **Repo-locus code-path references** section to `docs/agent/conventions.md` (the convention text,
...
- Added the authoring note to `docs/agent/backlog-workflow.md` (Authoring an item) so new items comply from
  creation, pointing at the conventions.md rule.

...
- `playground-harness.ts`, `playground.css` — shared conformance infra (still WE-resident for the 17
...
- `durable-tier-verification/{index.html,durable-tier-verification.ts,durable-sw.js}` — the durable
  surface (A′ / #708).

 ...
 * the original argv, inherited stdio, and the real exit code — a transparent pass-through in every other way.
...
// cache stays fresh, however long the session itself runs — never a one-time value stale after ~1h.
'use strict';
...
const env = token ? Object.assign({}, process.env, { GH_TOKEN: token }) : process.env;

...
import {
  ...
  DEFAULT_RETRY_BASE_MS, DEFAULT_RETRY_CAP_MS, DEFAULT_HEADER_WAIT_CAP_MS,
  resolveGhCap, resolveAcquireTimeoutMs, resolveRetryMaxAttempts, resolveHeaderWaitCapMs,

...
export const CRITERIA = Object.freeze([
  ...
  criterion({
    ...
    hunt: 'A tool call shape this rubric version can name as a clear duplicate of a declared operation (e.g. a hand-rolled `gh` invocation of `pr create`/`pr merge` where an `op()`-declared operation exists). Deliberately conservative — a false positive here is worse than a miss.',

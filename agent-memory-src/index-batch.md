...
- [pr-land dogfood mechanics](pr-land-dogfood-mechanics.md) — --park is the ONLY hold (--no-wait is NOT); --body-file; behind-main→rebase; --admin blocked; gh-pr-create 401→REST; self-heals id collisions; #2181

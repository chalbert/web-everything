...
**Codified:** the canonical rule is `docs/agent/platform-decisions.md#intents-ux-only` (the statute is source-of-truth; any `#NNN` above is provenance, not the reference).

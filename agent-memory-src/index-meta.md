...
- [Land on no-regression, not on perfection](232-feedback_land_on_no_regression_not_perfection.md) — the land bar is **no regression + no new impact**, NOT "no findings"; incompleteness is filed and landed, a false denial or a new way to damage something is fixed first. Ruled after #1031 bounced 4 rounds and #1037 2 more with EVERY finding in the guard and none in the fix, each repair growing the diff (241→407→472) while the queue stood still. Reviewers must now label each finding regression/impact (blocking) vs incompleteness (file-and-land)

...
- [Tracked items = the tracker](tracked-items-means-tracker.md) — "tracked items" means the epic 3383 tracker; planned work lives only in the tracker and filed cards, never only in the handoff (operator 2026-09-20)

...
- [Never write scratch files under .git/](feedback_avoid_bash_heredoc_file_writes.md) — `.git` is a Claude Code hardcoded protected path, prompts with any tool regardless of allow-list; use os.tmpdir() instead; confirmed live 2026-08-17

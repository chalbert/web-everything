...
- [Avoid Bash heredoc file writes](feedback_avoid_bash_heredoc_file_writes.md) — `cat > f << EOF` prompts even with bare Bash allowed (bypasses Edit/Write hooks); use the Write tool instead; confirmed live 2026-08-17

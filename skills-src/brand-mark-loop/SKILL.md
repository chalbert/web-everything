...
Every user verdict is a labeled example — append it to the WE #2207 learning log with the principle it
encodes. The journey + labels ARE the fixture the design-AI reviewer (#2207) trains and regresses
against.

...
/** Computed background colour of a chip — the SELECTED TINT under test (#2280). The fixture loads the real
...
// ── #2280: the readiness chips' SELECTED TINT must track real pressed state, not the SSR attribute ──
...
test('toggling a readiness chip OFF strips its tint though the SSR `selected` attribute survives (#2280)', async ({ page }) => {

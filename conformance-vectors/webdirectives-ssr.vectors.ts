 ...
 *
 * **Language-neutral export (#2354):** this TS module is the source of truth; `webdirectives-ssr.vectors.json`
 * (generated by `npm run gen:webdirectives-ssr-vectors`, drift-tested by
 * `__tests__/webdirectives-ssr-export.test.ts`) is the plain-JSON projection any non-JS renderer harness
 * (#2069) reads without a Node/TS toolchain. The byte-for-byte grading protocol a harness applies to a
 * candidate renderer's output is pinned in `webdirectives-ssr-harness-contract.md`.
 */

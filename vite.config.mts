...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      '^/(projects|adapters|intents|capabilities|compat|protocols|design-systems|presets|plugs/(?!.*\\.ts)|cases|mission|semantics|states|resources|author|governance|rules|research|backlog|validation-rules|conformance|project-lifecycle|specs|assets|css|js|sitemap.xml|build-id.json)': {
        target: ELEVENTY_TARGET,
        changeOrigin: true,
      },

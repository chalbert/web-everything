...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      '^/(projects|adapters|intents|capabilities|protocols|presets|plugs/(?!.*\\.ts)|cases|mission|semantics|states|resources|author|governance|research|backlog|validation-rules|project-lifecycle|assets|css|js|sitemap.xml)': {
        target: 'http://localhost:8080',
        changeOrigin: true,
      },

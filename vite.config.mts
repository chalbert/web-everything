...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      '^/(projects|adapters|intents|capabilities|protocols|design-systems|presets|plugs/(?!.*\\.ts)|cases|mission|semantics|states|resources|author|governance|research|backlog|validation-rules|conformance|project-lifecycle|assets|css|js|sitemap.xml|build-id.json)': {
        target: 'http://localhost:8080',
        changeOrigin: true,
      },

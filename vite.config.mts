...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      '^/(projects|adapters|intents|capabilities|protocols|plugs/(?!.*\\.ts)|cases|mission|semantics|states|resources|author|research|backlog|validation-rules|project-lifecycle|assets|css|js)': {
        target: 'http://localhost:8080',
        changeOrigin: true,
      },
